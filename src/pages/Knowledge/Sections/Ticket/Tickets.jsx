...
function TicketsGeneral() {
      ...
      >
        ...
        <div>
          <article className="pt-5 font-roboto font-light text-[14px] text-grisHeading">
            ...
            <p>Para dar seguimiento del ticket, debes dar clic en el botón de la columna “Acciones”. Se abrirá una nueva ventana con las siguientes características:
            </p><br />
            <span>1. Columna del lado derecho, se visualizará la información general del ticket.
            </span>
            <ol className="mt-4 mb-4">
  ...
  <li className="before:content-['h.'] before:mr-2">
    La categoría.
            ...
            <span>2. Columna del lado izquierdo, se visualizará algunas acciones que podrán realizarse con el ticket:</span>
            <ol className="mt-4 mb-4">
  <li className="before:content-['a.'] before:mr-2">
    Acciones.
  </li>
