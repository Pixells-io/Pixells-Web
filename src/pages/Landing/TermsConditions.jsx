      ...
      <div className="mx-4 my-4 rounded-3xl bg-[#7794F915] px-6 py-6 text-center sm:mx-8">
        ...
        <div className="pt-10 text-left font-roboto text-base text-grisHeading sm:px-20">
          <span>
            ...
            <br />
            <br />
            2. Al dar clic en “aceptar”, o bien, al utilizar nuestros programas
            ...
            <br />
            <br />
            5. El almacenamiento en la nube es una gran ventaja tecnológica. No
            ...
            aceptar y vincularte bajo los términos y condiciones y políticas de
            ellos.
            <br />
            <br />
            ...
            <br />
            <br />
            Este resumen no agota ni sustituye al texto completo de nuestros
            términos y condiciones que se encuentran a continuación:
            <br />
            <br />
            1. GENERALES.
            <br />
            ...
            <br />
            <br />
            3.2 ALCANCES Y LIMITES DE LA LICENCIA
            <br />
            <br />
            ...
            así convenir a sus intereses, en el que exterioriza su voluntad por
            medio DEL “CLICK” DE ACEPTACIÓN AL FINAL DE LA LECTURA DEL MISMO, DE
            ...
            <br />
            <br />
            A través de nuestros programas usted como usuario capturará,
            editará, eliminará y en general administrará sus datos personales y
            comerciales, mismos que trataremos de acuerdo con nuestro AVISO DE
            PRIVACIDAD y nuestras políticas de confidencialidad. Usted es
            ...
            <br />
            <br />
            Para la correcta interpretación y alcance de nuestros Términos y
            Condiciones y Políticas de Privacidad, se disponen las siguientes
            definiciones.
            <br />
            <br />
            ...
            <br />
            <br />
            LICENCIA. El contenido de los derechos adquiridos por el usuario con
            la adquisición del PROGRAMA.
            <br />
            <br />
            ...
            implica el suministro de infraestructura, plataforma o software, por
            medio del cual podemos brindar un servicio con mayor capacidad de
            almacenamiento y permitiendo la movilidad de los datos almacenados.
            <br />
            <br />
            ...
            <br />
            <br />
            INFORMACIÓN COMERCIAL. La información sobre el negocio o comercio
            del USUARIO, incluyendo datos sobre precios, proveedores, cajas,
            identificadores de productos, inventarios, facturación, entre otros
            relacionados con el negocio o comercio.
            <br />
            <br />
            CRÉDITO. Se refiere a la función de nuestros programas mediante los
            cuales el usuario puede registrar, administrar y mantener un control
            de los créditos otorgados a sus clientes.
            <br />
            <br />
            CAJA PRINCIPAL. Es el equipo de cómputo de un establecimiento
            designado para administrar la base de datos, usuarios y cajas
            adicionales que se vincula a través de una red de computadoras para
            compartir la información del programa con las cajas adicionales.
            <br />
            <br />
            MANUALES. Cualquier tipo de documento, impreso o digital, que
            explique los alcances y funcionalidad de los programas, el modo o
            método para su utilización adecuada.
            <br />
            <br />
            3. LICENCIA DE USUARIO
            <br />
            ...
            <br />
            <br />
            La licencia comprende el uso total del “PROGRAMA” para la
            administración, manejo o gestión del los procesos de su negocio.
            Incluyendo todas las secciones del programa.
            <br />
            <br />
            La licencia también comprende el almacenamiento e instalación del
            “PROGRAMA” en una o varias computadoras en cualquier
            establecimiento, sujeto al tipo de licencia que adquiera. Se
            entiende que el "PROGRAMA" se almacena, utiliza o instala en una
            computadora cuando el mismo se carga en la memoria temporal (RAM) o
            en la memoria permanente (disco duro) de la computadora.
            <br />
            <br />
            La licencia comprende el uso del “PROGRAMA” dentro del tiempo pagado
            y sin restricción de cantidad de datos almacenados, número de
            transacciones o montos límite.
            <br />
            <br />
            La licencia comprende 1 usuario master que estará asociado a un
            establecimiento físico identificado. El número de USUARIOS que
            pueden utilizar simultáneamente el "PROGRAMA" es libre.
            <br />
            <br />
            El precio de la licencia lo puede conocer a través de nuestros
            agentes de venta. El pago es mensual, es decir, una vez adquirida la
            licencia tendrá que completar los pagos mes a mes para mantener la
            licencia activa. Esto excluye a los costos por desarrollos
            adicionales o ajustes en el desarrollo.. Por favor, consulte los
            apartados “alcances y límites de la licencia” y “actualizaciones”
            para conocer los costos asociados.
            <br />
            <br />
            La licencia adquirida comprende actualizaciones, mientras la
            licencia se mantenga activa..
            <br />
            <br />
            3.2 ALCANCES Y LIMITES DE LA LICENCIA
            <br />
            <br />
            La licencia de usuario otorgada no comprende las siguientes
            cuestiones:
            <br />
            <br />
            La difusión, reproducción, transformación o transmisión material o
            electrónica de nuestros productos o de sus contenidos;
            <br />
            <br />
            ...
            ni realizar cualquier otra operación que tienda a descubrir el
            código fuente o sobrepasar los mecanismos de protección de este;
            <br />
            <br />
            Alterar, modificar, sustituir, eliminar o en cualquier forma
            manipular o afectar los códigos originales y/o ejecutables del
            programa, la funcionalidad, aspecto visual o seguridad de este;
            <br />
            <br />
            Cargar contenido en nuestros productos que contengan virus, malware,
            gusanos, troyanos, código malicioso u otros dispositivos que pueda
            dañar nuestra infraestructura o sistemas técnicos o los de terceros;
            <br />
            <br />
            Transferir su usuario y contraseña de acceso a terceros;
            <br />
            <br />
            Participar en actividades fraudulentas con contenidos del programa;
            <br />
            <br />
            Utilizar nuestro programa para infringir derechos de autor, derechos
            de propiedad industrial u otros derechos de naturaleza análoga,
            propiedad de terceros.
            <br />
            <br />
            Permitir, tolerar o fomentar a cualquier tercero a realizar alguna
            de las actividades anteriormente descritas.
            <br />
            <br />
            ...
            <br />
            <br />
            El "PROGRAMA" podrá verificar de forma automática, sin notificación
            ni consentimiento del USUARIO vía Internet el estado de la LICENCIA
            para verificar que esté vigente y no haya sido trasladada o
            desactivada por cualquier motivo.
            <br />
            <br />
            En caso de robo, el usuario deberá adjuntar a su solicitud una copia
            digital del acta de denuncia, en donde conste el robo del equipo de
            cómputo vinculado con la licencia, interpuesto ante las autoridades
            de su localidad para obtener el reemplazo sin costo de la licencia.
            Si el usuario no adjunta la copia del acta de denuncia el reemplazo
            se tramitará como un reemplazo de licencia por daños o
            descomposturas siendo gratuita la primera reposición o debiendo
            cubrir los montos correspondientes si se trata de un reemplazo
            subsecuente.
            <br />
            <br />
            ...
            <br />
            <br />
            Para la adecuada instalación y uso de nuestro programa debe disponer
            de un equipo de cómputo con los siguientes requerimientos mínimos:
            <br />
            <br />
            ...
            <br />
            <br />
            b) La reparación o actualización del PROGRAMA en caso de errores
            subsanables;
            <br />
            <br />
            c) La sustitución o reemplazo del "PROGRAMA" que no reúna las
            instrucciones de programación que se establecen en el Manual y/o
            Instructivo de Uso que acompaña al "PROGRAMA".
            <br />
            <br />
            ...
            <br />
            <br />
            La presente garantía será inválida en caso de que la falla del
            "PROGRAMA" o, en su caso, del (los) disco (s) sea resultado de
            accidente, ingeniería inversa, abuso o uso indebido del programa por
            culpa atribuible al usuario, sus empleados, agentes o
            representantes.
            <br />
            <br />
            ...
            posible, buscaremos resolver los errores en el uso de los servicios,
            ...
            funciones, capacidades, compatibilidades o mejorar el programa.
            <br />
            <br />
            El proceso de actualización no afecta a las bases de datos,
            ...
            <br />
            <br />
            La devolución del pago de una licencia o producto procederá cuando
            ...
            el uso total del "PROGRAMA" para la administración, manejo o gestión
            del punto de venta de su negocio, sin limitaciones en tiempo,
            cantidad de datos, número de transacciones o montos límite, sujeto a
            las disposiciones de estos términos y condiciones.
            <br />
            <br />
            No obstante, son usos aceptados aquellos que se refieran en el
            Manual de uso del programa, en estos términos y condiciones, o bien,
            aquellos que vayan directamente a la leal y justificada utilización
            del programa.
            <br />
            <br />
            Son usos no aceptados, además de los señalados en otras partes de
            estos términos y condiciones:
            <br />
            <br />
            El uso del programa para fines ilícitos como fraudes, usura, evasión
            fiscal y cualquier otra finalidad que contravenga alguna disposición
            normativa en su lugar de residencia.
            <br />
            <br />
            El uso del programa para infringir derechos sobre marcas
            comerciales, patentes, derechos de autor, derecho a la imagen
            propia, entre otras violaciones a derechos legalmente adquiridos por
            terceros.
            <br />
            <br />
            El uso del programa en relación con términos violatorios de los
            derechos del consumidor.
            <br />
            <br />
            El uso del programa con la finalidad de hacerse ilegalmente de la
            información de terceros, violar la privacidad o confidencialidad de
            éstos.
            <br />
            <br />
            El uso del programa para la comercialización, oferta o promoción de
            venta de productos, sustancias o, en general, cualquier objeto o
            cosa cuya comercialización sea considerada ilícita en su lugar de
            residencia.
            <br />
            <br />
            El cobro de productos o servicios a través del programa con medios
            de pago no aceptados por las autoridades de su país.
            <br />
            <br />
            Modificar el programa con la finalidad de agregar medios de pago no
            ...
            <br />
            <br />
            El uso de programas de cómputo que permitan la utilización remota
            del programa instalado en otro equipo de cómputo.
            <br />
            <br />
            El uso del programa con la finalidad de alterar indebidamente su
            información contable o situación fiscal.
          </span>
        </div>
      </div>
